...
const ReminderSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'notificationId': PropertySchema(id: 5, name: r'notificationId', type: IsarType.long),
    r'transactionId': PropertySchema(id: 6, name: r'transactionId', type: IsarType.long),
    r'type': PropertySchema(id: 7, name: r'type', type: IsarType.string, enumMap: _RemindertypeEnumValueMap),
  },
...
Reminder _reminderDeserialize(Id id, IsarReader reader, List<int> offsets, Map<Type, List<int>> allOffsets) {
  ...
  object.type = _RemindertypeValueEnumMap[reader.readStringOrNull(offsets[7])] ?? ReminderType.oneTime;
  return object;
}
...
extension ReminderQueryFilter on QueryBuilder<Reminder, Reminder, QFilterCondition> {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> notificationIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(property: r'notificationId'));
    });
  }

  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> notificationIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(property: r'notificationId'));
    });
  }

  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> notificationIdEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(property: r'notificationId', value: value));
    });
  }

  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> notificationIdGreaterThan(int? value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(include: include, property: r'notificationId', value: value));
    });
  }

  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> notificationIdLessThan(int? value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.lessThan(include: include, property: r'notificationId', value: value));
    });
  }

  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> notificationIdBetween(int? lower, int? upper, {bool includeLower = true, bool includeUpper = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.between(property: r'notificationId', lower: lower, includeLower: includeLower, upper: upper, includeUpper: includeUpper));
    });
  }
