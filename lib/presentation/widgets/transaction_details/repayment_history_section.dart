          ...
          children: [
            Row(
              children: [
                ...
                Text('Repayment History', style: theme.textTheme.titleMedium),
              ],
            ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('No repayments recorded yet', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onSurfaceVariant)),
                    ],
                  ),
                ),
              )
